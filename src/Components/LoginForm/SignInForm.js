                        ...
                        <div className="flex xl:justify-center  justify-center items-center flex-wrap h-full g-6">
                            <div className=" w-[300px]">
                                ...
                                <div className="text-center">
                                    <button
                                        onClick={singInFunc}
                                        className="w-full mb-3 py-2 bg-theme-shade  text-black border border-green-500  hover:bg-green-500 hover:text-white text-sm rounded shadow-md "
                                    >
                                        LOGIN WITH EMAIL
                                    </button>
                                    {/* <button
                                        onClick={singInFunc}
                                        className="w-full mb-5 py-2 bg-theme-shade  text-black border border-blue-500  hover:bg-blue-500 hover:text-white text-sm rounded shadow-md "
                                    >
                                        LOGIN WITH GOOGLE
                                    </button> */}
                                    <LoginWithSocial />
                        ...
                        <div className="flex xl:justify-center  justify-center items-center flex-wrap h-full g-6">
                            <div className=" w-[300px]">
                                ...
                                <div className="text-center">
                                    <button
                                        onClick={singUpFunc}
                                        className="w-full mb-3 py-2 bg-theme-shade hover:bg-green-500 hover:text-white text-black border border-green-500 font-medium text-sm rounded shadow-md "
                                    >
                                        SIGN UP WITH EMAIL
                                    </button>
                                    {/* <button
                                        onClick={singUpFunc}
                                        className="w-full mb-5 py-2 bg-theme-shade hover:bg-blue-500 hover:text-white text-black border border-blue-500 font-medium text-sm rounded shadow-md "
                                    >
                                        SIGN UP WITH GOOGLE
                                    </button> */}
                                    <LoginWithSocial />
