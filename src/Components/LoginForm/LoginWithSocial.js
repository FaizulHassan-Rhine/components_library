...
const LoginWithSocial = () => {
    ...
    return (
        <div className="container mx-auto">
            <div className="flex items-center justify-center my-2 before:flex-1 before:border-t before:border-gray-300 before:mt-0.5 after:flex-1 after:border-t after:border-gray-300 after:mt-0.5">
            ...
            <div className="flex flex-col justify-center w-full  gap-5">
                <div className=" flex justify-center">
                    ...
                    <button onClick={twitterSignIn} className="w-full mb-5 py-1 bg-theme-shade text-blue-500 border border-blue-500  hover:bg-blue-500 hover:text-white text-sm rounded shadow-md "><i class="fa-brands  text-lg fa-twitter mr-4"></i>
                        LOGIN WITH TWITTER
                    </button>
                </div>
