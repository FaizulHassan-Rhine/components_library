...
const PriceCard = () => {
    return (
        <div className="flex items-center font-serif justify-center flex-col bg-[#E5E5E5] min-h-screen">
            {/* main card */}
                ...
                <div className="flex flex-col md:flex-row space-x-0 md:space-x-8 space-y-12 md:space-y-0 justify-center items-center mt-10">
                    <div className="bg-[#FFFBEC] rounded-xl">
                        <div className="flex flex-col p-8 rounded-xl bg-white shadow-xl translate-x-4 translate-y-4 w-96 md:w-auto">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Ice_logo.svg/138px-Ice_logo.svg.png?20191213230535" className="w-8" alt="Ice Mobile" />
                            ...
                            <button className="bg-[#F4F5FA] px-4 py-3 hover:bg-green-300 rounded-full border border-[#F0F0F6] shadow-xl mt-4">
                                Add subscription
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#F9ECFF] rounded-xl">
                        <div className="flex flex-col p-8 rounded-xl bg-white shadow-xl translate-x-4 translate-y-4 w-96 md:w-auto">
                            <img src="https://www.dstny.se/app/uploads/telia_pp_rgb.png.webp" className="w-12" alt="Telia Mobil" />
                            ...
                            <button className="bg-[#F4F5FA] px-4 py-3 rounded-full hover:bg-green-300 border border-[#F0F0F6] shadow-xl mt-4">
                                Add subscription
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#ECEEFF] rounded-xl">
                        <div className="flex flex-col p-8 rounded-xl bg-white shadow-xl translate-x-4 translate-y-4 w-96 md:w-auto">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Telenor_Logo.svg/1600px-Telenor_Logo.svg.png" className="w-12" alt="Telenor Next Fast" />
